...
Color conversion: RGB → YCbCr with adaptive 4:4:4 / 4:2:0 sampling

CDF 9/7 Wavelet Transform (5-6 levels)

Adaptive subband quantization

SPIHT entropy coding (Set Partitioning In Hierarchical Trees)

LZMA-style Range Coder with context-adaptive models
...
🗺️ Roadmap
☑ Wavelet transform + SPIHT
☑ Adaptive quantization
☑ PNG/JPG direct support
